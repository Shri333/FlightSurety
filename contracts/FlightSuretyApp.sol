...
contract FlightSuretyApp {
    ...
    */   
    function registerAirline
                            ...
                            returns (bool, uint)
    {
        return data.registerAirline(msg.sender, airlineAddress);         
    }
    ...
    */  
                                ...
                                requireIsOperational
    {
        ...
        require(!flights[key].isRegistered, "Cannot register a registered flight");
...
// region ORACLE MANAGEMENT
    ...
    uint private constant MIN_RESPONSES = 3;
                            ...
                            returns (uint8)
    {
        ...
        uint8 random = uint8(uint(keccak256(abi.encodePacked(blockhash(block.number - nonce++), account))) % maxValue);
...
contract FlightSuretyData {
    function registerAirline(address, address) external returns (bool, uint);
    function creditInsurees(address, string, uint) external;
}
